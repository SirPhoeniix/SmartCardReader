========================================================================
    KONSOLENANWENDUNG: SmartCardReader-Projektübersicht
========================================================================

Diese SmartCardReader-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre SmartCardReader-Anwendung besteht.


SmartCardReader.vcxproj
...
SmartCardReader.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen SmartCardReader.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
